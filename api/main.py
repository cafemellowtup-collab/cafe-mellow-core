...
from api.routers import cron, ledger, analytics, hr, ceo_brief, upload, chat, sync, oracle, forecast, ingester, users, notifications
...
app.add_middleware(
    ...
    allow_origin_regex=r"^http:\/\/(localhost|127\.0\.0\.1|\d{1,3}(?:\.\d{1,3}){3}):30\d{2}$",
