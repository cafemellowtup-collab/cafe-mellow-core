...
**Version 4.1 - Universal Semantic Brain Edition** | January 2026  
**Last Updated:** January 31, 2026

---

## 📋 Module Index (Master Map)

This table provides a quick reference for any Agent or Developer to locate key features:

| Module Name | Directory | Purpose | Key API Endpoints | Status |
|-------------|-----------|---------|-------------------|--------|
| **TITAN v3 (The Brain)** | `backend/core/titan_v3/` | AI Logic, Personality Engine, GraphRAG Memory, Self-Learning | `/api/v1/chat/stream`, `/api/v1/titan/v3/health` | ✅ Production |
| **Master Dashboard (The Admin)** | `backend/master/` | Tenant Registry, Health Monitor, Feature Flags, Usage Tracking | `/api/v1/titan/v3/health`, `/api/v1/master/*` | ✅ Production |
| **Universal Adapter (The Ingestion)** | `backend/universal_adapter/` | Data Pipeline, File Ingestion, Semantic Classification, Event Ledger | `/api/v1/ingest/file`, `/api/v1/adapter/*`, `/api/v1/brain/*` | ✅ Production |
| **Pillars (Domain Logic)** | `pillars/` | Config Vault, Dashboard Analytics, Chat Intelligence, RBAC | Used internally by routers | ✅ Production |
| **Data Sync (ETL)** | `01_Data_Sync/` | PetPooja Sync, Google Drive Sync, Expense Parsing | Scheduled jobs / manual scripts | ✅ Production |
| **Web Frontend** | `web/src/` | Next.js 16 + React 19, Chat UI, Dashboard, Settings | `http://localhost:3000/*` | ✅ Production |

### Quick Links to Module Documentation
- **TITAN v3 (Brain):** [`backend/core/titan_v3/README.md`](backend/core/titan_v3/README.md)
- **Master (Admin):** [`backend/master/README.md`](backend/master/README.md)
- **Universal Adapter:** [`backend/universal_adapter/README.md`](backend/universal_adapter/README.md)
